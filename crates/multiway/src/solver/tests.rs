...
impl ExternalSamplingGame for NodeEvalToyGame {
    ...
    fn next_state_with(
        ...
        match actions {
            ...
            NodeEvalState::OpponentChoice => NodeEvalState::Terminal(NodeEvalTerminal::Showdown),
...
fn evaluate_node_actions_rejects_bad_path_index_and_terminal_early() {
    ...
    let bad_index = evaluate_node_actions(&game, &sampler, &strategy, &[7], 8, 1, 64).unwrap_err();
    assert!(matches!(
        bad_index,

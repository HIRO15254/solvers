    ...
    fn web_multiway_preset_snapshots_pass_rust_validation() {
        const PRESETS: [(&str, &str, usize); 4] = [
            (
                ...
                include_str!("../../../apps/preflop/web/presets/multiway-9max-pushfold.toml"),
                9,
            ),
            (
                "multiway-9max-mtt-icm",
                include_str!("../../../apps/preflop/web/presets/multiway-9max-mtt-icm.toml"),
                9,
            ),
            (
                "multiway-6max-cash",
                include_str!("../../../apps/preflop/web/presets/multiway-6max-cash.toml"),
                6,
            ),
            (
                "multiway-9max-research",
                include_str!("../../../apps/preflop/web/presets/multiway-9max-research.toml"),
                9,
            ),
        ];

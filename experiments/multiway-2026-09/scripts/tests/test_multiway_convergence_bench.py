...
MODULE_PATH = Path(__file__).resolve().parents[1] / "multiway_convergence_bench.py"
SPEC = importlib.util.spec_from_file_location("multiway_convergence_bench", MODULE_PATH)

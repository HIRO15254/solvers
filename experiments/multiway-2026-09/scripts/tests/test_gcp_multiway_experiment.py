...
experiment.ROOT = Path(__file__).resolve().parents[4]
experiment.BASE_CONFIG = experiment.ROOT / "examples/bench_multiway/6max_20bb_checkdown.toml"
experiment.DEFAULT_CACHE = experiment.ROOT / ".cache/gcp-ehs2"

...
Evidence is retained in [stage1 summary](output/local-parallel-traversal-screen/stage1-summary.json),
[stage2 summary](output/local-parallel-traversal-screen/stage2-summary.json),
and [monitor summary](output/local-parallel-traversal-screen/monitor-summary.json).
